...
public class StartNoteEditingFragmentTestOnContainerCommandTest {
    ...
    @Test
    public void testIfMethodExecuteStartsNoteEditingFragmentOnActivity() {
        ...
        try (ActivityController<AppCompatActivity> controller = Robolectric.buildActivity(AppCompatActivity.class)) {
            ...
            assertTrue(fragmentContainer instanceof NoteEditingFragment);
        }
    }
}
