...
public class NoteComponentTest {
    ...
    @Test
    public void fetchingNotesFromServiceAndStoringOnDatabase() {
    ...
    @Test
    public void fetchingNotesFromDatabase() {
        TestObserver<List<NoteEntity>> notesFromDatabase = noteDataAccessObject.getNotes().test();
    ...
    @Test
    public void creatingNoteOnServiceAndOnDatabase() {
    ...
    @Test
    public void updatingNoteOnServiceAndOnDatabase() {
    ...
    @Test
    public void deletingNoteOnServiceAndOnDatabase() {
        ...
        TestObserver<List<NoteEntity>> noteFromDatabase = noteDataAccessObject.getNotes().test();

        noteFromDatabase.assertValue(List::isEmpty);
    }
}
