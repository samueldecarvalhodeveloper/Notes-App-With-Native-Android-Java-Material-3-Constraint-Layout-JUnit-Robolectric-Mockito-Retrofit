...
public class NoteBodyTextInputTextChangeEventHandler implements TextWatcher {
    private final NoteEditingViewModel noteEditingViewModel;

    public NoteBodyTextInputTextChangeEventHandler(NoteEditingViewModel noteEditingViewModel) {
    ...
    public void onTextChanged(
        ...
        noteEditingViewModel.updateNoteBody(textInputCurrentValue.toString());
    }
